              ...
              filteredScores.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Athlete Name */}
                    <td className="px-4 py-3.5 whitespace-nowrap align-middle font-medium">
                      <div className="text-sm font-semibold text-slate-100 group-hover:text-emerald-400 transition-colors notranslate flex items-center gap-1.5" translate="no">
                        {row.name}
                        {isChallengeCompleted && (
                          <span className="inline-flex px-1.5 py-0.5 bg-amber-500/15 border border-amber-500/30 text-[9px] font-bold text-amber-400 rounded-md font-mono animate-pulse gap-0.5" title="Concluiu o Desafio Mensal!">
                            🏆 CONCLUÍDO
                          </span>
                        )}
                      </div>
                    ...
                    <td className="px-4 py-3.5 whitespace-nowrap text-center align-middle">
                      <span className="inline-flex px-2.5 py-1 rounded-lg text-xs font-bold font-mono bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                        {row.totalPoints.toFixed(1)} pontos
                      </span>
                    </td>
                    ...
                    {/* Distance Points */}
                    <td className="px-4 py-3.5 whitespace-nowrap text-center align-middle text-slate-300 font-mono text-xs">
                      <div className="flex items-center justify-center gap-1">
                    ...
                    {/* Summary Volume Info (Tie Breakers) */}
                    <td className="px-4 py-3.5 whitespace-nowrap text-right align-middle font-mono font-medium text-slate-400">
                      <div>{row.totalDistance.toFixed(1)} km</div>
                    </td>
                  </tr>
                );
              })
