                ...
                <div className="space-y-2 max-h-[220px] overflow-y-auto pr-1 custom-scrollbar">
                  {myRecentActs.map((act) => {
                    ...
                    return (
                      <div 
                        key={act.id} 
                        className="flex items-center justify-between p-3 rounded-xl bg-slate-950/60 border border-slate-900 hover:border-slate-850 transition-all text-xs font-sans"
                      >
                        ...
                        {confirmDeleteId === act.id ? (
                          <div className="flex items-center gap-1.5 shrink-0 animate-fadeIn font-sans notranslate" translate="no">
                            <span className="text-[11px] text-red-400 font-bold mr-1">Excluir?</span>
                            <button
                              type="button"
                              onClick={(e) => {
                                e.stopPropagation();
                              ...
                              className="px-2.5 py-1.5 bg-red-600 hover:bg-red-500 text-slate-100 text-[10px] font-bold rounded-lg transition-colors cursor-pointer shadow-sm"
                            >
                              Sim
                            </button>
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-slate-800 hover:bg-slate-750 text-slate-400 text-[10px] font-bold rounded-lg transition-colors cursor-pointer"
                            >
                              Não
                            </button>
                          </div>
